...
def spread_example():
    ...
    strike_price_long = 147
    premium_long = 2.15
    strike_price_short = 150
    premium_short = 1.40
    right = "call"
    range_multiple = 0.1

    stock_price_range = np.arange(
        (1 - range_multiple) * underlying_price, (1 + range_multiple) * underlying_price
    )
...
def long_strangle_example():
    ...
    long_strangle_net = strangle_or_straddle(
        underlying_price,
        strike_price_call,
        premium_call,
        strike_price_put,
...
def short_strangle_example():
    ...
    short_strangle_net = strangle_or_straddle(
        underlying_price,
        strike_price_call,
        premium_call,
        strike_price_put,
...
def long_straddle_example():
    ...
    long_straddle_example = strangle_or_straddle(
        underlying_price,
        strike_price_call,
        premium_call,
        strike_price_put,
...
def short_straddle_example():
    ...
    short_straddle_example = strangle_or_straddle(
        underlying_price,
        strike_price_call,
        premium_call,
        strike_price_put,
...
def call_debit_spread_example():
    ...
    cds = call_credit_or_debit_spread(
        underlying_price,
        strike_price_long,
        premium_long,
        strike_price_short,
...
def put_debit_spread_example():
    ...
    pds = put_credit_or_debit_spread(
        underlying_price,
        strike_price_long,
        premium_long,
        strike_price_short,
...
def call_credit_spread_example():
    ...
    cds_credit = call_credit_or_debit_spread(
        underlying_price,
        strike_price_long,
        premium_long,
        strike_price_short,
...
def put_credit_spread_example():
    ...
    pds_credit = put_credit_or_debit_spread(
        underlying_price,
        strike_price_long,
        premium_long,
        strike_price_short,
...
def call_example(short=False, plot=True):
    ...
    call = call_option(
        underlying_price, strike_price, premium, stock_price_range, short, plot
    )
